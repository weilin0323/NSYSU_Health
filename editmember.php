...
<body>
  ...
  <div class="login_area">
    <div class="contain active">
      ...
      <form name="editmemberform" id="editmemberform" action="member_check.php"  method="post">
        <div class="router">
          <label for="member_name">會員姓名<font color="#FF0000">*</font></label>
          <input type="text" placeholder="請輸入使用者姓名" id="account" name="account" required>
        </div>
        <div class="router">
          <label for="email">信箱<font color="#FF0000">*</font></label>
          <input type="text" placeholder="請輸入使用者信箱" id="email" name="email" required>
        </div>
        <div class="router">
        ...
        <div class="router">
          ...
          <input type="text" placeholder="請輸入使用者手機號碼" id="telephone" name="telephone" required>
        </div>
        <div class="router">
          <label for="birth">生日<font color="#FF0000">*</font></label>
          <input type="date"  id="birth" name="birth" minlength="10" maxlength="10" required>
        </div>
        <div class="router">
        ...
        <div class="login"><span id="but" onclick="check();" type="submit">註冊</span></div><br>
        <div class="login"><a href="login.php">取消</a></div>
