  ...
  <div class="product_contain">
    <div class="list">
      <ul>
        ...
        <li>
          <a href="video2.php">健身飲食</a>
        </li>
        <li>
          <a href="video3.php">減肥舞</a>
        </li>
      </ul>
    </div>
    <div class="products_box">
      <div class="items">
          ...
          <div class="item">
            <div class="item_info">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/Z1u5wYKZ9DQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class="item_info">    
              <iframe width="560" height="315" src="https://www.youtube.com/embed/IqIo-5GNLmo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class="item_info">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/qMBvQfmRQ1c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
            </div>
          </div>
