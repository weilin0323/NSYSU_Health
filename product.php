    ...
    <div class="products_box">
      <div class="items">
        <?php 
              ...
              if($_POST["value"]!=""){
                $value = $_POST["value"];
                $sql="SELECT * FROM product_all WHERE product_name like '%$value%'"; 
        ...
        ?> 
                  <div class="item">
                    <div class="img_box">
                    <a href="productinform<?php echo $row['product_id'] ?>.php">
                      <img src="img/product_all/item<?php echo $row['product_id'] ?>.jpg" alt="">
