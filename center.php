<?php 
  ...
  $info_sql = "SELECT * FROM `member` WHERE member_id = '".$_SESSION["islogin"]."'";
  $res = mysqli_query($conn , $info_sql);
  $info = mysqli_fetch_array($res);
  //$_SESSION["islogin"] = $_SESSION["islogin"];
  // echo $_SESSION["username"];
  // echo $_SESSION["email"];
  // echo $_SESSION["passsword"];
...
<body>
  ...
  <header>
    <nav class="pc_menu">
    <ul >
            <li><a href="#memberform">帳戶資訊</a></li>
            <li><a href="#accountform">訂單資訊</a></li>
          </ul>
    </nav>
  </header>
  ...
  <div class="login_area">
    ...
    <h1>帳戶資訊</h1>  
      <form name="editmemberform" id="editmemberform" action="./_center.php"  method="post">
        <div class="router">
          <label for="member_name">會員姓名<font color="#FF0000">*</font></label>
          <input type="text" placeholder="使用者姓名" id="account" name="account" value="<?php echo $info["member_name"]; ?>"required>
        </div>
        <div class="router">
          <label for="email">信箱<font color="#FF0000">*</font></label>
          <input type="text" placeholder="使用者信箱" id="emails" name="email" value="<?php echo $info["email"]; ?>"readonly>
        </div>
        <!-- <div class="router">
          <label for="password">密碼<font color="#FF0000">*</font></label>
          <input type="password" placeholder="使用者密碼" id="passwords" name="password" required>
        </div> -->
        <div class="router">
          <label for="birth">生日<font color="#FF0000">*</font></label>
          <input type="date"  id="birth" name="birth" minlength="10" maxlength="10" value="<?php echo $info["birth"]; ?>"required>
        </div>
        <div class="router">
          <label for="gender" >性別<font color="#FF0000">*</font></label>
            <select id="sex" name="sex" style="width:400px;">
                <?php             
                    if (isset($info["gender"])){
                      echo "<option value='".$info['gender']."' selected> ".$info["gender"]."</option>";
                    }else{
                      echo "<option>請選擇性別</option>";
                      }
                ?>
        ...
        <div class="router">
          <label for="phone">手機號碼<font color="#FF0000">*</font></label>
          <input type="text" placeholder="手機號碼" id="telephones" name="telephone" value="<?php echo $info["phone"]; ?>"required>
        </div>
    
        <div class="login"><span id="but" onclick="check();" type="submit">確認修改</span></div><br>
        <div class="login"><a href="changepassword.php">修改密碼</a></div><br>
  ...
  <div class="container2" style="display: block; ">
    <div class="login_area" id="accountform" style="background-color: white; width:80%"> 
    <div class="contain active" style="height: 700px;width:100vw">
   
    <h1>訂單資訊</h1>
      
    <form name="editmemberform" id="orderform" action=""  method="post">
          <div style="display: flex;">
            <div class="box" style=" border:2px solid white;margin:1rem;background-color:#ffe180" >
                <img src="./img/food-photographer-jennifer-pallian-306895-unsplash.jpg" style="width: 200px;height:200px"  alt="">
                <img src="./img/item5.jpg" style="width: 200px;height:200px"  alt="">
                  <div  style="margin: 1rem; ">
            
                    <label for="member_name" style="padding: 1rem;">訂單編號<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
                    <label>35721467</label>
                  </div>
                    <div   style="margin: 1rem; ">
                    <label for="member_name" style="padding: 1rem;">狀態<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
                    <label style="margin-left:32px;">已發貨</label>
                    </div>
                    <div   style="margin: 1rem; ">
                      <label for="member_name" style="padding: 1rem;">總花費<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
                      <label style="margin-left:15px;">$2458</label>
                    </div>
            
              </div>
              <div class="box" style="border:2px solid white;margin:1rem;background-color:#ffe180 " >
                <img src="./img/food-photographer-jennifer-pallian-306895-unsplash.jpg" style="width: 200px;height:200px"  alt="">
                <img src="./img/item4.jpg" style="width: 200px;height:200px"  alt="">
                  <div   style="margin: 1rem; ">
            
                    <label for="member_name" class="labels" style="padding: 1rem;">訂單編號<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
                    <label class="labels">35721468</label>
                  </div>
                    <div   style="margin: 1rem; ">
                    <label for="member_name" style="padding: 1rem;">狀態<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
                    ...
                    <div  style="margin: 1rem; ">
                      <label for="member_name" style="padding: 1rem;">總花費<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
                      <label style="margin-left:15px;">$1500</label>
                    </div>
            
              </div>
              <div class="box" style="border:2px solid white;margin:1rem;background-color:#ffe180" >
                <img src="./img/item3.jpg" style="width: 200px;height:200px"  alt="">
                <img src="./img/item1.jpg" style="width: 200px;height:200px"  alt="">
                  <div  style="margin: 1rem; ">
            
                    <label for="member_name" style="padding: 1rem;">訂單編號<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
                    <label>35721469</label>
                  </div>
                    <div   style="margin: 1rem; ">
                    <label for="member_name" style="padding: 1rem;">狀態<font color="#FF0000"></font></label>
                  <!-- <label for="member_name" >123456<font color="#FF0000"></font></label> -->
