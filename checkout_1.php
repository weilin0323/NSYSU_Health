...
<body>
  <form action="pay_1.php" method="post">
  <header>
    <nav class="pc_menu">
      <div class="logo">
    ...
    <div class="steps">
      ...
      <div class="set">
        <div>
          ...
          <input type="text" name="first" id="first" placeholder="王" required>
        </div>
        <div>
          <label for="last">名字</label>
          <input type="text" name="last" id="last" placeholder="小明" required>
        </div>
      </div>
      <div class="set">
        <div>
          <label for="pnumber">電話</label>
          <input type="tel" name="pnumber" id="pnumber" inputmode="numeric" pattern="[0-9]{10}" maxlength="10" placeholder="0912345678" required>
        </div>
      </div>
      <div class="set">
        <div>
          <label for = "add1">地址</label>
          <input type="text" name="add1" id="add1" placeholder="高雄市" required>          
        </div>
        <div>
          <label for = "add2"></label>
          <input type="text" name="add2" id="add2" placeholder="新興區" required> 
          
        </div>
      </div>
      <div class="set">
        <div>
          <input type="text" name="add3" id="add3" placeholder="幸福路520號" required>
        </div>
      </div>     
      <input type="submit" value="下一步" class="next" style="width:460px;height:100px; href="checkout_2.php">
