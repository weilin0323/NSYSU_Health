<?php 
    ...
    if(isset($_GET['action']) && $_GET['action']=="add"){ //點擊加入購物車
        ...
        if(isset($_SESSION['cart'][$id])){ //如果該商品已加入購物車
            ...
            $sql_s="SELECT * FROM product_other WHERE product_id={$id}"; 
    ...
    <div class="products_box">
      <div class="items">
        <?php 
              ...
              if($_POST["value"]!=""){
                $value = $_POST["value"];
                $sql="SELECT * FROM product_other WHERE product_name like '%$value%'"; 
        ...
        ?> 
                  <div class="item">
                    <div class="img_box">
                      <img src="img/product_other/item<?php echo $row['product_id'] ?>.jpg" alt="">
                      <p class="cate">本日精選</p>
