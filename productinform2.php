    ...
    <div class="products_box">
      <div class="items">
        <?php 
                ...
                $sql="SELECT * FROM product_all WHERE product_id=2 "; 
        ...
        ?> 
                ...
                <div class="col-md-5" style="width:400px; height:auto; float:left; display:inline;">
                    <span >
                      ...
                      <div class="text">
                      🌿每份皆含 20g以上蛋白質<br>
                      🌿耗時兩年傾力研發，選用豌豆萃取及優質乳源<br>
                      🌿提供各飲食需求族群，新的蛋白補給選擇方案<br>
                      🌿多種口味任君挑選，堅持健康降低甜味劑使用<br>
                      🌿獨有配方研發，補充蛋白質同時攝取多樣營養<br>
                      🌿兼顧各族群需求，成分選用堅持六大訴求特色<br>
